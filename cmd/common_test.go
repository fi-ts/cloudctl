...
import (
	...
	"bou.ke/monkey"
	mockclient "github.com/fi-ts/cloud-go/test/client"
...
func (c *test[R]) newMockConfig(t *testing.T) (*mockclient.CloudMockClient, *bytes.Buffer, *config) {
	mock, client := mockclient.NewCloudMockClient(c.mocks)

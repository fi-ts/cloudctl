...
func newProjectCmd(c *config) *cobra.Command {
	...
	cmdsConfig := &genericcli.CmdsConfig[*models.V1ProjectCreateRequest, *models.V1ProjectUpdateRequest, *models.V1ProjectResponse]{
		...
		ListCmdMutateFn: func(cmd *cobra.Command) {
			...
			must(cmd.RegisterFlagCompletionFunc("id", c.comp.ProjectListCompletion))
			must(cmd.RegisterFlagCompletionFunc("tenant", c.comp.TenantListCompletion))
		},
	}
...
func (c projectCmd) Get(id string) (*models.V1ProjectResponse, error) {
	resp, err := c.client.Project.FindProject(project.NewFindProjectParams().WithID(id), nil)
	if err != nil {
		return nil, err
	}
...
func (c projectCmd) List() ([]*models.V1ProjectResponse, error) {
	resp, err := c.client.Project.FindProjects(project.NewFindProjectsParams().WithBody(&models.V1ProjectFindRequest{
...
func (c projectCmd) Delete(id string) (*models.V1ProjectResponse, error) {
	resp, err := c.client.Project.DeleteProject(project.NewDeleteProjectParams().WithID(id), nil)
	if err != nil {
		return nil, err
	}
...
func (c projectCmd) Create(rq *models.V1ProjectCreateRequest) (*models.V1ProjectResponse, error) {
	resp, err := c.client.Project.CreateProject(project.NewCreateProjectParams().WithBody(rq), nil)
	if err != nil {
...
func (c projectCmd) Update(rq *models.V1ProjectUpdateRequest) (*models.V1ProjectResponse, error) {
	resp, err := c.client.Project.FindProject(project.NewFindProjectParams().WithID(rq.Meta.ID), nil)
	if err != nil {
		return nil, err
	}
	...
	updateResp, err := c.client.Project.UpdateProject(project.NewUpdateProjectParams().WithBody(rq), nil)
	if err != nil {
		return nil, err
	}

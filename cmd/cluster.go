...
func newClusterCmd(c *config) *cobra.Command {
	...
	clusterCreateCmd.Flags().String("default-pod-security-standard", "", "sets default pod security standard for clusters >= v1.23.x, defaults to restricted on clusters >= v1.25 (valid values: privileged, baseline, restricted)")
	...
	clusterUpdateCmd.Flags().String("default-pod-security-standard", "", "set default pod security standard for cluster >=v 1.23.x (valid values: privileged, baseline, restricted)")

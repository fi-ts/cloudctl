## cloudctl postgres promote-to-primary

promote a standby instance to become a replication primary

```
cloudctl postgres promote-to-primary [flags]
```

### Options

```
  -h, --help          help for promote-to-primary
      --synchronous   make the replication synchronous
```

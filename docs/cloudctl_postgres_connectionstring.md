...
return the connectionstring for a postgres

```
cloudctl postgres connectionstring <postgres> [flags]
```

### Options

```
  -h, --help          help for connectionstring
      --type string   the type of the connectionstring to create, can be one of psql|jdbc (default "psql")
```

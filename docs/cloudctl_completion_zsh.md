...
To load completions in your current shell session:
	...
	source <(cloudctl completion zsh); compdef _cloudctl cloudctl
...
#### macOS:
	...
	cloudctl completion zsh > $(brew --prefix)/share/zsh/site-functions/_cloudctl

You will need to start a new shell for this setup to take effect.


```
cloudctl completion zsh [flags]
```

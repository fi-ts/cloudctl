## cloudctl s3 remove-key

remove a key for an s3 user

```
cloudctl s3 remove-key <id> [flags]
```

### Options

```
      --access-key string   specify the access key to delete the access / secret key pair

## cloudctl cluster machine console

console access a machine/firewall of the cluster

```
cloudctl cluster machine console <clusterid> [flags]
```
...
```
  -h, --help               help for console
      --machineid string   machine to connect to.
```

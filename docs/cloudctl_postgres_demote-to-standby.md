## cloudctl postgres demote-to-standby

demote a the replication primary to become a standby instance

```
cloudctl postgres demote-to-standby [flags]
```

### Options

```
  -h, --help   help for demote-to-standby
```

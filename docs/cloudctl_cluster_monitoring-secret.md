## cloudctl cluster monitoring-secret

returns the endpoint and access credentials to the monitoring of the cluster

```
cloudctl cluster monitoring-secret <clusterid> [flags]
```

### Options

```
  -h, --help   help for monitoring-secret
```

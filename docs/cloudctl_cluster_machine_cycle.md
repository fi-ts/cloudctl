## cloudctl cluster machine cycle

soft power cycle of a machine/firewall of the cluster

```
cloudctl cluster machine cycle <clusterid> [flags]
```
...
```
  -h, --help               help for cycle
      --machineid string   machine to reset.
```
